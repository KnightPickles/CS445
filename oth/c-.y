...
%token <token.input> SEMICOLON COMMA COLON LBRACK RBRACK LPEREN RPEREN LCURL RCURL 
...
program					: declaration_list { syntaxTree = $1; printf("TOP\n");} 
						;
